...
Vejam o arquivo de exemplo - [infile.nex](./MrBayes_Jobs/infile.nex).
...
arguments               = --mca plm isolated --oversubscribe -np 8 /usr/local/bin/mb /endereço/completo/do/infile.nex
