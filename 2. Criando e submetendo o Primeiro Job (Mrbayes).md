# Criando e Submetendo o Primeiro Job (Mrbayes)

## 1. Enviando arquivos para o servidor

No teu terminal do teu computador, use (no Windows digite windows+R e em seguida cmd):
...
## 3. Ao abrir o editor em mrbayes.sub, cole o conteúdo abaixo (ex.: Ctrl+Shift+V ou Ctrl+V).
