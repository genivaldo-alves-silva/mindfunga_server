...
- Se quiser rodar o clássico como no CIPRES, onde usava RAxML-HPC v.8 on ACCESS, com 'Rapid bootstrap analysis / search for best-scoring ML tree (-f a)', vá para o [item 3.5](#35-submetendo-jobs-para-análise-mv-ml-com-raxml-hpc).
...
Use o arquivo de exemplo [infile.fas](./ML_Jobs/infile.fas).
...
## 3.4 Analisando o arquivo de input ([.fas](./ML_Jobs/infile.fas)) para descobrir quanto recurso computacional será necessário e será alocado no servidor para você nesta análise de ML com RAxML-NG
...
- Do arquivo: `./infile.fas.raxml.log`.
```log
[...]
...
- Veja o arquivo de exemplo - [raxmlng.sub](./ML_Jobs/RAxML/raxmlng.sub).
...
- Vamos criar e editar o arquivo de submissão.
- Veja o arquivo de exemplo - [raxmlhpc.sub](./ML_Jobs/RAxML/raxmlhpc.sub).
