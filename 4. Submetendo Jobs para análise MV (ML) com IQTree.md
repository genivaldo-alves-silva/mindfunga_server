...
## Vejam que abaixo há duas linhas de argumento. Usem somente uma. A primeira opção é com a matriz multiloci em um único arquivo. A segunda opção são as várias regiões do DNA separas. !! Nesta segunda opção deve ter cuidado com o nome dos espécimes. Eles devem ser iguais em todas matrizes e quando o espécime x não tem dado para região y com z de tamanho, ele deve aparecer na lista mesmo que com - ou ? na quantidade correspondente ao tamanho da matriz.
