...
## Vejam que abaixo há duas linhas de argumento. Usem somente uma.
...
- A terceira opção você também pode usar matrizes separadas, mas elas não precisam ser adicionadas com -s. Ao subir o arquivo de partição [.nex](./ML_Jobs/IQTree/partition_iqtree_nex.nex) usando -p, nele o programa terá acesso ao arquivos.
