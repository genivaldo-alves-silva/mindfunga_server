...
## 3. Ao abrir o editor em mrbayes.sub, cole o conteúdo abaixo (ex.: Ctrl+Shift+V).
...
## 5. O arquivo mrbayes.sub pode ser criado e editado no teu computador e ser transferido junto com o infile.nex
...
## 6. Acompanhando o Job, verificando resultados e download
...
## 7. Verificou que a corrida conclui ou você encontrou o arquivo .tre. Vamos transferir os arquivos necessários para o teu computador e verificar os arquivos .p no TRACER e a .tre no FIGTREE.
...
## Alternativas de manipulação de vários arquivos existem. Veja algumas possibilidades em 6. Manipulação de arquivos.
